...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="image">
            <img class="tilt" src="frontend/images/about-pic.jpg" alt="">
        </div>
...
<section class="portfolio" id="portfolio">
    ...
    <div class="box-container">
        ...
        <div class="box tilt">
            <img src="frontend/images/img-1.jpg" alt="">
            <div class="content">
        ...
        <div class="box tilt">
            <img src="frontend/images/img-2.jpg" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
        ...
        <div class="box tilt">
            <img src="frontend/images/img-3.jpg" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
        ...
        <div class="box tilt">
            <img src="frontend/images/img-4.jpg" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
        ...
        <div class="box tilt">
            <img src="frontend/images/img-5.jpg" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
        ...
        <div class="box tilt">
            <img src="frontend/images/img-6.jpg" alt="">
            <div class="content">
                <a href="#" class="btn">learn more</a>
            </div>
        </div>
...
<section class="blogs" id="blogs">
    ...
    <div class="box-container">
        ...
        <div class="box tilt">
            <img src="frontend/images/blog-img-1.jpg" alt="">
        ...
        <div class="box tilt">
            <img src="frontend/images/blog-img-2.jpg" alt="">
            <h3> blogs title goes here </h3>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quam sint tenetur adipisci explicabo nisi libero, in rerum earum. Dolor, quibusdam!</p>
            <a href="#" class="btn">learn more</a>
        </div>
...
<section class="contact" id="contact">
    ...
    <div class="row">
        ...
        <div class="image">
            <img class="tilt" src="frontend/images/contact-img.svg" alt="">
        </div>
